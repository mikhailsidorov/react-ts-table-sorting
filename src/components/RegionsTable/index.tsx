...
import { IRegion, IRegionListProps } from '../../models';
...
export const RegionsTable: FC<IRegionListProps> = ({ regions }) => {
  ...
  const getColumnSearchProps = (dataIndex: string): IColumsSearchProps => {
    ...
    const render: (text: string, region: IRegion) => JSX.Element | string = (
      text,
      region
    ) =>
